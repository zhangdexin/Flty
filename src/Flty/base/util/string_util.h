...
BASE_EXPORT bool StringReplaceFirst(const std::string& find, const std::string& replace, std::string& output);
BASE_EXPORT bool StringReplaceFirst(const std::wstring& find, const std::wstring& replace, std::wstring& output);
...
BASE_EXPORT BOOL StringStartWith(const std::wstring &str, const std::wstring &sub);
BASE_EXPORT BOOL StringStartWith(const std::string &str, const std::string &sub);
BASE_EXPORT BOOL StringEndWith(const std::wstring &str, const std::wstring &sub);
BASE_EXPORT BOOL StringEndWith(const std::string &str, const std::string &sub);

BASE_EXPORT std::string StringJoin(const std::list<std::string>& lst, const std::string& joinstr);
BASE_EXPORT std::wstring StringJoin(const std::list<std::wstring>& lst, const std::wstring& joinstr);
BASE_EXPORT std::string StringJoin(const std::set<std::string>& lst, const std::string& joinstr);
BASE_EXPORT std::wstring StringJoin(const std::set<std::wstring>& lst, const std::wstring& joinstr);
BASE_EXPORT std::string StringJoin(const std::vector<std::string>& lst, const std::string& joinstr);
BASE_EXPORT std::wstring StringJoin(const std::vector<std::wstring>& lst, const std::wstring& joinstr);
