...
//获取某个文件夹下的所有子文件名
BASE_EXPORT void GetSubFileNames(const std::string& path, std::list<std::string>& files, bool bIncludeFolder = true);
BASE_EXPORT void GetSubFileNames(const PathString& path, std::list<PathString>& files, bool bIncludeFolder = true);
